...
userRouter.get('/mypage/:userId', loginRequired, userController.getUserByAdmin); //TODO: admin 사용자가 다른 사용자정보 조회가능
userRouter.post('/mypage/:userId', userController.updateUserByAdmin); //TODO: admin 사용자가 다른 사용자 업데이트 가능
userRouter.delete('/mypage/:userId', userController.deleteUserByAdmin); //TODO: admin 사용자가 다른 사용자 탈퇴가능
